...
Here we reduce the dataset by filtering only the columns we are going to need in this practicum.
...
fifa_df_reduced['position_category']
```

### Grouping the buckets

Second step involves grouping the buckets and calculating the count of preferred_foot for each.
